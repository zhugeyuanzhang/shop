...
) ENGINE = InnoDB DEFAULT CHARSET = UTF8MB4 COMMENT '游戏图片映射表';
...
) ENGINE = InnoDB DEFAULT CHARSET = UTF8MB4 COMMENT '游戏-标签映射表';